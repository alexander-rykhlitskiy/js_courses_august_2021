...
1. Определить объект с двумя полями и записать его в переменную
2. Поменять значение второго поля у этого объекта

1. Определить массив из пяти чисел
2. Вывести в консоль третий элемент массива
3. в цикле for вывести в консоль каждый элемент массива

3 раза попросить пользователя ввести число. Вывести в диалоговом окне (alert) сумму введенных чисел.



    let numberOfStudents = prompt('Число студентов');
    let numberOfTeachers = prompt('Число учителей');

    if (numberOfStudents > numberOfTeachers) {
      alert(numberOfStudents)
    } else if (numberOfTeachers > numberOfStudents) {
      alert(numberOfTeachers)
    } else {
